              ...
              if (this.__currentElement.nodeName === 'path') {
                ...
                throw new Error(
                  'Attempted to apply path command to node ' +
                    this.__currentElement.nodeName
                );
              }
            };
      ...
      2: [
        function(require, module, exports) {
          ...
          Context.prototype.__createElement = function(
            ...
            var element = C2S.prototype.__createElement.call(
              this,
              elementName,
              properties,
              resetFill
            );
            var currentGeneration = this.generations[
              ...
              while (ctx.generations.length > 1) {
                ...
                while (count > 0) {
                  ...
                  if (count === lastCount) {
                    ...
                    var liveGeneration =
                      ctx.generations[ctx.generations.length - 1];
      ...
      8: [
        function(require, module, exports) {
          module.exports = function(p5) {
             ...
             * @private
             */
            p5.prototype._svg_get = function(
              path,
              successCallback,
              failureCallback
            ) {
          ...
          module.exports = function(p5) {
            ...
            RendererSVG.prototype._setGCFlag = function(element) {
              ...
              var currentGeneration =
                that.generations[that.generations.length - 1];
              currentGeneration.push(element);
            };
            ...
            RendererSVG.prototype.image = function(
              ...
              elt =
                elt ||
                (img.nodeName && img.nodeName.toLowerCase() == 'svg' && img); // <svg>
              if (elt) {
          ...
          module.exports = function(p5) {
            ...
            SVGFilters.apply = function(svgElement, func, arg) {
              ...
              if (!oldfilter) {
                ...
                oldfilter.elt.parentNode.replaceChild(
                  filter.elt,
                  oldfilter.elt
                );
              }
            ...
            SVGFilters.colorMatrix = function(
              inGraphics,
              resultGraphics,
              matrix
            ) {
            ...
            SVGFilters.threshold = function(inGraphics, resultGraphics, val) {
              var elements = [];
              elements.push(
                SVGFilters.gray(inGraphics, resultGraphics + '-tmp')
              );
            ...
            SVGFilters._blendOffset = function(
              inGraphics,
              resultGraphics,
              mode
            ) {
            ...
            SVGFilters.erode = function(inGraphics, resultGraphics) {
              return SVGFilters._blendOffset(
                inGraphics,
                resultGraphics,
                'darken'
              );
      ...
      11: [
        function(require, module, exports) {
          ...
          module.exports = function(p5) {
             ...
             *
             */
            p5.prototype.loadGraphics = function(
              graphics,
              successCallback,
              failureCallback
            ) {
              if (graphics._renderer.svg) {
                ...
                var url = SVGCanvas.prototype.toDataURL.call(
                  graphics._renderer.elt,
                  'image/svg+xml'
                );
                var pg = this.createGraphics(
                  graphics.width,
                  graphics.height,
                  constants.SVG
                );
            ...
            p5.prototype.createCanvas = function(w, h, renderer) {
              ...
              if (renderer === constants.SVG) {
                ...
                this._setProperty(
                  '_renderer',
                  new p5.RendererSVG(c, this, true)
                );
